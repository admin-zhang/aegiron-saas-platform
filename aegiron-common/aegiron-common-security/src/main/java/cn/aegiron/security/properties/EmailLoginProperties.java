 ...
 * <p>默认值说明：</p>
 * <ul>
 *   <li>{@code enabled=false}：不开启邮箱验证码登录。</li>
 *   <li>{@code codeExpireSeconds=300}、{@code codeLength=6}：验证码默认 5 分钟、6 位。</li>
 *   <li>在配置文件中通过 {@code aegiron.security.login.email.*} 设置时，会自动覆盖这些默认值。</li>
 * </ul>
 *
 * @author panda
 * @since 2026/2/26
 */
@Data
@ConfigurationProperties(prefix = "aegiron.security.login.email")
